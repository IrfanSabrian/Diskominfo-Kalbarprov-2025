...
var searchResultsHeading = document.querySelector('.search-results'); // heading for search results
var noResults = document.querySelector('.no-results'); // no results message
var resultsAvailable = false; // Did we get any search results?
var first, last; // To track the first and last search results

// Check if mobileMenu exists and define it if it doesn't
var mobileMenu = document.querySelector('.mobile-menu') || { classList: { toggle: function() {} } };

// Hide search results heading and no results message by default
...
function openSearch() {
  ...
  // Close the mobile menu when search is clicked
