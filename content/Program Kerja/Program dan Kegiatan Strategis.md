...
date: 2023-09-22
thumbnail: /images/program_kerja.png
---
<section class="">
    <div class="relative bg-white dark:bg-gray-600" style="height: 360px; background-image: url('/images/program_kerja.png'); background-repeat: no-repeat; background-position: center; background-size: 100% auto;">
...
<div class="">
    <div class="mb-16 mt-8 px-8" style="max-height: 500px; overflow: hidden">
        <img id="myImg" class="mx-auto" src="/images/program_kerja.png" alt="Gambar Program dan Kegiatan Strategis" style="width: 100%; max-width: 600px;">
    </div>
