...
<script>
  ...
  document.addEventListener("DOMContentLoaded", function() {
    const containerSopPeraturan = document.querySelector('.section-container-panduan');
    panduan.forEach(item => {
      const urlPath = `/ms-panduan/${titleToUrl(item.title)}`;
...
<section class="flex flex-col gap-4 bg-white dark:bg-gray-800 section-container-panduan">
</section>
<style>
